...
function create() {
    ...
    btn_setting = game.add.button(370, 10, 'btn_setting', onclickSetting, this, 0);
    btn_setting.scale.setTo(0.5, 0.5);
...
function onclickSetting() {
    rectangle = game.add.tileSprite(40, 50, 0, 0, 'rectangle');
    rectangle.scale.setTo(1.2, 1.5);
    btn_option = game.add.button(70, 240, 'btn_option', onclickSound, this, 0);
    btn_question = game.add.button(70, 340, 'btn_question', onclickSound, this, 0);
    btn_cancel = game.add.button(310, 210, 'btn_cancel', onclickCancel, this, 0);
    btn_cancel.scale.setTo(0.5, 0.5);
}

function onclickCancel() {
    rectangle.visible = !rectangle.visible;
    btn_option.visible = !btn_option.visible;
    btn_question.visible = !btn_question.visible;
